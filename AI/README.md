...
* 📌 **Conversational AI**
    * Conversational AI Chatbots → **ChatGPT**, **Claude**, **Bing Chat**
    * Representative Models: **GPT**, **LaMDA**, **Gemini**

* 📌 **Speech-to-Text (STT)**
    * Voice to Text Conversion → **Siri**, **Google Assistant**, **AI Callbot**
    * Representative Models: **Whisper**, **DeepSpeech**

* 📌 **Text-to-Speech (TTS)**
    * Text to Voice Conversion → **Naver Clova**, **Google TTS**
...
* 📌 **Named Entity Recognition (NER)**
    ...
    * ex. "Admiral Yi Sun-sin was born in 1545." → **Yi Sun-sin**: Person, **1545**: Date

* 📌 **Relation Extraction**
    * Identifying relationships between entities
    * ex. "Steve Jobs founded Apple." → **Steve Jobs**, Founder, **Apple**
...
* 📌 **Image Generation**
    ...
    * Examples: **DALL·E**, **Stable Diffusion**, **Midjourney**, **NovelAI**
